...
app.post("/analyze", upload.single("image"), async (req, res) => {
  try {
    ...
    const result = await model.generateContent([
      "Analyze this plant image and provide detailed analysis of its species,The plant's name in different languages English, Sanskrit, Telugu, and Hindi, Detailed explanation of each part of the plant used in health care , health, and care recommendations, its characteristics, care instructions, and any interesting facts,describe about that plant. Please provide the response in plain text without using any markdown formatting.",
      {
        inlineData: {
